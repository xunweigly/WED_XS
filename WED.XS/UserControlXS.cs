    ...
    public partial class UserControlXS : UserControl
    {
      ...
      private void UserControl1_Load(object sender, EventArgs e)
       ...
       public void chuli()
       {
           ...
           try
           {
                       ...
                       if (iXgbs == 1)
                       {
                           ...
                           {
                               sql = String.Format("update zdy_wed_sobom_qr set mjyl='{3}', iqtybom2= '{0}',ixql = '{1}' where  id = '{2}'",
       ...
       private void CxMx(string id)
       {
        ...
        i.cinvname as sjname,i.cinvstd as sjgg,i.cinvdefine7 as sjgy
           ...
           where lx <>2  and isosid ='{0}' order by id", id));
                        ...
                        if (e.RowIndex != -1)
                        {
                            ...
                            string bZhengbao =DbHelper.GetDbString(dataGridView3.Rows[e.RowIndex].Cells["bZhengbao"].Value);
                                ...
                                if (bZhengbao == "是")
                                {
                                    ...
                                    dMaxqty = Math.Ceiling(dMaxqty / 25) * 25;
                                    dMaxKscsl = Math.Floor(dMaxqty / dMaxyl);
                                ...
                                for (int i = 0; i < dt2.Rows.Count; i++)
                                {
                                    ...
                                    if (i != iMax)
                                    {
                                        ...
                                        {
                                            iQtybom = Math.Ceiling(dDjyl * dMaxKscsl * 100) / 100;


                                        }
                                        else
                                        {
                                            iQtybom = Math.Ceiling(dDjyl * dMaxKscsl);
                                        }
                                    }
                                    else
                                    {
